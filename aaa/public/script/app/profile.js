async function loadprofile() {
    ...
    try {
        ...
        document.getElementById("flag").innerHTML = `<img id="flag" src="${data.countrylink}" alt="Country Flag">`;
        ...
        if (!data.address) {
            ...
            <form id="addressForm">
                <div class="addressinput">
                    <input id="inputlightning" type="text" placeholder="username@domain.gg" required pattern="^[^@]+@[^@]+$" title="Please input a valid lightning address"></input>
        ...
        if (data.address) {
            ...
            <form id="addressForm">
                <div class="addressinput">
                    <input id="inputlightning" type="text" placeholder="${data.address}" required pattern="^[^@]+@[^@]+$" title="Please input a valid lightning address"></input>
...
document.getElementById('address').addEventListener('submit', async (e) => {
    ...
    e.preventDefault();
    const authToken = getCookie("auth");
    const address = document.getElementById("inputlightning").value;
